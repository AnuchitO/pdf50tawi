...
func main() {
	...
	signature := flag.String("signature", "cmd/demo-cli/demo-signature-1024x278.png", "Signature png image file")
	logo := flag.String("logo", "cmd/demo-cli/demo-logo-410x361.png", "Logo png image file")
	flag.Parse()
